...
public class AddUrlScenarios
{
    ...
    public async Task Should_return_shortened_url()
    {
        ...
        response.Value!.ShortUrl.Should().Be(expected: "1");
    }
    ...
    private static AddUrlRequest CreateAddUrlRequest(string createdBy = "petar")
    {
        return new AddUrlRequest(new Uri("https://www.google.com"),
           createdBy);
    }
}
